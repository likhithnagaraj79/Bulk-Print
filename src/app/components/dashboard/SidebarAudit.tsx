...
import { Users, FileText, Menu, X, LogOut } from "lucide-react";
...
export function SidebarAudit({ collapsed, onToggle }: SidebarProps) {
  ...
  const menuItems = [
    { icon: Users, label: "Manage Admins", path: "/super-admin", active: location.pathname === "/super-admin" },
    { icon: FileText, label: "Audit Logs", path: "/super-admin/audit", active: location.pathname === "/super-admin/audit" },
  ];
